  ...
  return (
    <AdminLayout>
      <div className="border-b border-[#EAECF0] bg-white px-8 py-4">
        ...
        <p className="text-[13px] text-[#667085]">Overview of platform activity</p>
      </div>
          ...
          <div className="rounded-xl border border-[#EAECF0] bg-white p-6 shadow-sm">
            <div className="flex items-center gap-4">
              <div className="flex h-12 w-12 items-center justify-center rounded-xl bg-blue-50">
                <UserPlus className="h-6 w-6 text-[#1a6fa8]" />
              </div>
              <div>
            ...
            {loading ? (
              ...
              <ResponsiveContainer width="100%" height={250}>
                <BarChart data={studentChartData}>
                  ...
                  <Tooltip contentStyle={{ borderRadius: '12px', border: '1px solid #EAECF0', boxShadow: '0 4px 12px rgba(0,0,0,0.05)' }} labelStyle={{ color: '#101828', fontWeight: 600, fontSize: 13 }} />
