          ...
          <Card className="rounded-xl border-[#EAECF0] shadow-sm">
            <CardContent className="p-6">
              ...
              <p className="mt-2 text-[11px] text-[#98A2B3]">
                <strong>Remove</strong> hides this application from company view only.
              </p>
            </CardContent>
          </Card>
        ) : (
                  ...
                  <div className="flex items-center gap-3">
                    ...
                    <div className="flex items-center gap-2 shrink-0" onClick={(e) => e.stopPropagation()}>
                      ...
                      {deleteConfirm === app._id ? (
                        ...
                        <button onClick={() => setDeleteConfirm(app._id)} className="rounded-lg border border-[#EAECF0] p-1.5 text-[#667085] hover:bg-red-50 hover:text-red-600" title="Remove">
