          ...
          {activeConv ? (
            <>
              ...
              <div className="flex items-center gap-3 border-b border-[#EAECF0] px-5 py-3">
                ...
                <div className="flex h-9 w-9 items-center justify-center rounded-full bg-[#1a6fa8] text-[12px] font-semibold text-white shrink-0">
                ...
                <Badge variant="outline" className="rounded-full border-emerald-200 bg-emerald-50 text-[10px] font-medium text-emerald-700 shrink-0">
