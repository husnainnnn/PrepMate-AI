...
import {
  Bell, Volume2, Monitor, Moon, Sun, User, Trash2, KeyRound,
      ...
      <div className="space-y-6 px-6 py-6 lg:px-8">
        ...
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <p className="text-[13px] text-[#667085] dark:text-[#94A3B8]">Customize your experience</p>
          </div>
        </div>
                        ...
                        >
                          <div className={`flex h-5 w-5 shrink-0 items-center justify-center rounded-full border-2 transition-colors ${
                            selectedTone === tone.id
                              ...
                              : 'border-[#D0D5DD] dark:border-[#475569] group-hover:border-[#98A2B3] dark:group-hover:border-[#64748B]'
                          }`}>
                            {selectedTone === tone.id && <Check className="h-3 w-3 text-white" />}
                          </div>
                          <div className="flex-1 min-w-0">
                            <p className={`text-[13.5px] font-medium ${
                              selectedTone === tone.id ? 'text-[#1a6fa8]' : 'text-[#101828] dark:text-[#F1F5F9]'
                            }`}>{tone.name}</p>
                    ...
                    <div className="flex items-start justify-between gap-4">
                      <div className="flex items-start gap-3">
                        ...
                        <div>
                          ...
                          <p className="mt-0.5 text-[12.5px] text-[#667085] dark:text-[#94A3B8] leading-relaxed">
                            Get push notifications on your desktop even when the tab is in the background.
                          </p>
                        </div>
                      </div>
                      <button
                ...
                <CardContent className="p-6">
                  <div className="flex items-center gap-3">
                    <div className="flex h-9 w-9 items-center justify-center rounded-lg bg-violet-50 dark:bg-violet-900/30">
                      {darkMode ? (
                        <Moon className="h-[18px] w-[18px] text-violet-600 dark:text-violet-400" />
                      ) : (
                        <Sun className="h-[18px] w-[18px] text-violet-600 dark:text-violet-400" />
                      )}
                    </div>
                    <div>
                  ...
                  <div className="mt-6 grid grid-cols-2 gap-4">
                    ...
                    <button
                      ...
                      className={`flex flex-col items-center gap-3 rounded-xl border-2 p-6 transition-all ${
                        !darkMode
                          ? 'border-[#1a6fa8] bg-gradient-to-b from-[#1a6fa8]/5 to-transparent shadow-sm'
                          : 'border-[#EAECF0] dark:border-[#334155] bg-white dark:bg-[#1E293B] hover:border-[#D0D5DD] dark:hover:border-[#475569]'
                      }`}
                    >
                      ...
                      <span className={`text-[14px] font-semibold ${!darkMode ? 'text-[#1a6fa8]' : 'text-[#667085] dark:text-[#94A3B8]'}`}>
                        Light
                      </span>
                    </button>

                    {/* Dark mode — click to switch TO dark */}
                    <button
                      onClick={() => !darkMode && toggleDarkMode()}
                      className={`flex flex-col items-center gap-3 rounded-xl border-2 p-6 transition-all ${
                        darkMode
                          ? 'border-[#1a6fa8] bg-gradient-to-b from-[#1a6fa8]/10 to-transparent shadow-sm'
                          : 'border-[#EAECF0] dark:border-[#334155] bg-white dark:bg-[#1E293B] hover:border-[#D0D5DD] dark:hover:border-[#475569]'
                      }`}
                    >
                    ...
                    <div className="mt-6 space-y-4">
                      ...
                      <div className="flex gap-2 pt-1">
                        <button
                          ...
                          className="rounded-lg border border-[#EAECF0] dark:border-[#334155] px-4 py-2 text-[12.5px] font-medium text-[#667085] dark:text-[#94A3B8] hover:bg-[#F7F9FC] dark:hover:bg-[#334155]"
                        >
                          Cancel
                        </button>
                        <button
                ...
                <CardContent className="p-6">
                  <div className="flex items-center gap-3">
                    <div className="flex h-9 w-9 items-center justify-center rounded-lg bg-blue-50 dark:bg-blue-900/30">
                      <User className="h-[18px] w-[18px] text-blue-600 dark:text-blue-400" />
                    </div>
                    <div>
                      <h2 className="text-[15px] font-semibold text-[#101828] dark:text-[#F1F5F9]">Profile</h2>
                      <p className="text-[12.5px] text-[#667085] dark:text-[#94A3B8]">Update your personal information and resume details</p>
                    </div>
                  </div>
                  ...
                  <div className="mt-6 rounded-xl bg-[#F7F9FC] dark:bg-[#0F172A] p-5">
                    <div className="flex items-center gap-4">
                      ...
                      <div className="flex-1 min-w-0">
                        <p className="text-[14px] font-semibold text-[#101828] dark:text-[#F1F5F9]">{user?.fullName || 'User'}</p>
                ...
                <CardContent className="p-6">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-[12.5px] text-[#667085] dark:text-[#94A3B8]">Permanently delete your account and all data</p>
                    </div>
                  </div>
                    ...
                    <div className="flex items-start gap-3">
                      ...
                      <div>
                        ...
                        <ul className="mt-2 space-y-1 text-[12.5px] text-red-700 dark:text-red-400 list-disc list-inside">
                          <li>Your profile and all personal data are permanently deleted</li>
                          <li>All your applications, interviews, and messages are removed</li>
                          <li>Your resume files are deleted</li>
                          <li>Companies you applied to will no longer see your application</li>
                  ...
                  {deleteError && (
                    <p className="mt-2 text-[12.5px] text-red-600 dark:text-red-400">{deleteError}</p>
                  )}
