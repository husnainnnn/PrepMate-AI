  ...
  return (
    <StudentDashboardLayout>
      <div className="px-6 py-6 lg:px-8">
        ...
        <p className="mt-1 text-[13.5px] text-[#667085]">Stay updated with your interview preparation progress.</p>
        <Card className="mt-6 rounded-xl border-[#EAECF0] shadow-sm">
          <CardContent className="p-8 text-center">
            ...
            <p className="mt-2 max-w-md mx-auto text-[13.5px] text-[#667085]">
              Get notified about interview tips, practice reminders, and application updates.
            </p>
          </CardContent>
        </Card>
      </div>
